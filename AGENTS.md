...
- `AI_WORKFLOW.md` — the owner's plan → spec → ARCHITECTURE.md → AGENTS.md → phase-based implementation workflow (per-module commits via jj). Read before anything about workflow/spec conventions.
